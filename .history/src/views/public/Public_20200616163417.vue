  ...
  data() {
    return {
      ...
      arr: [
        ...
        { name: "表格分页", log: "el-icon-location", index: "/mpaging" },
        { name: "已发布", log: "el-icon-menu", index: "/published" },
        { name: "统计", log: "el-icon-menu", index: "/statistics" },
        { name: "发表文章", log: "el-icon-check", index: "/publish" },
        { name: "标签页", log: "el-icon-setting", index: "/label" },
        { name: "导出excel", log: "el-icon-setting", index: "/iexport" },
        { name: "图片上传", log: "el-icon-setting", index: "/upload" },
        { name: "退出系统", log: "el-icon-delete-solid", index: "/out" }
      ]
    };
  },
  components: {},
