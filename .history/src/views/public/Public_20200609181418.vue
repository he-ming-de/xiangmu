  ...
  <div>
    <el-container>
      <el-header class="nav d-f a-i-c c-f j-c-s-b">
        ...
        <div>{{fist}}{{obj.username}} 上次登录时间：{{time}}</div>
      </el-header>
      <el-container>
        <el-aside width="200px"><div></div></el-aside>
        <el-main>
...
export default {
  ...
  mounted() {
    ...
    let fist = dayjs(this.obj.date).format("HH");
    if (fist > 6 && fist <= 12) {
      this.fist = "早上好，亲爱的";
    } else if (fist > 12 && fist <= 14) {
      this.fist = "中午好，亲爱的";
    } else if (fist > 14 && fist <= 18) {
      this.fist = "下午好，亲爱的";
    } else if (fist > 18 && fist <= 24) {
      this.fist = "晚上好，亲爱的";
    } else {
      this.fist = "该睡觉了，亲爱的";
    }
