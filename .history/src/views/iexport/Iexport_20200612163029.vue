<template>
  <div>
    ...
    <div class="m-t2 d-f">
      <download-excel class="export-excel-wrapper m-r1" :data="tableData.slice((currentpage-1)*pagesize,currentpage*pagesize)" name="filename.xls">
        <el-button type="primary" size="small">导出EXCEL</el-button>
      </download-excel>
      <download-excel class="export-excel-wrapper" :data="tableData.slice((currentpage-1)*pagesize,currentpage*pagesize)" name="filename.xls" type="csv">
        <el-button type="danger" size="small">导出 CSV</el-button>
      </download-excel>
    </div>
  </div>
</template>
