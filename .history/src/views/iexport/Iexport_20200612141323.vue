    ...
    <div class="d-f j-c-s-b m-t2">
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" isactive="isActive" @click="dialogVisible=true">
      ...
      <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
        <el-form>
          <el-form-item label="名称">
            <el-input v-model="value1" class="inputes"></el-input>
          </el-form-item>
          <el-form-item label="原价">
            <el-input v-model="value2" class="inputes"></el-input>
          </el-form-item>
          <el-form-item label="现价">
            <el-input v-model="value3" class="inputes"></el-input>
          </el-form-item>
        </el-form>
  ...
  watch: {
    value(val) {
      axios
        .get(`/api/tableData`)
        .then(res => {
          this.tableData = this.res.data.filter(item => {
