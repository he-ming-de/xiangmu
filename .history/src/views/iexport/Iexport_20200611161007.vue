<template>
  <div>
    <div>
      <input type="text" placeholder="请输入你想搜索的商品名称" class="inputs" v-model=""/>
    </div>
    <div class="d-f j-c-s-b m-t2">
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" isactive="isActive" @click="handleEdit(scope.$index, scope.row)">
