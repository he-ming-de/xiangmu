<template>
  <div>
    ...
    <div class="m-t2 d-f">
      <download-excel class="export-excel-wrapper" :data="json_data" name="filename.xls">
        <el-button type="primary" size="small">导出EXCEL</el-button>
      </download-excel>
      <download-excel class="export-excel-wrapper" :data="json_data" name="filename.xls" type="CSV">
